...
const ENDPOINT = "ENERGÍA_FOTOVOLTAICA/Comun/Acpvpc00PreciosPvpc/Acpvpc00"
const HOJAEXCEL = "excel/ENERGÍA_FOTOVOLTAICA/Comun/Acpvpc00.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Acpvpc00`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Acpvpc00)
