...
const ENDPOINT = "INSTALACIONES_ELÉCTRICAS_BT/RBT0_Memoria_Técnica_De_Diseño/Bt040402InstalaciónEléctricaDeViviendaUnifamiliarConGradoDeElectrificaciónElevado/Bt040402"
const HOJAEXCEL = "excel/INSTALACIONES_ELÉCTRICAS_BT/RBT0_Memoria_Técnica_De_Diseño/Bt040402.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Bt040402`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Bt040402)
