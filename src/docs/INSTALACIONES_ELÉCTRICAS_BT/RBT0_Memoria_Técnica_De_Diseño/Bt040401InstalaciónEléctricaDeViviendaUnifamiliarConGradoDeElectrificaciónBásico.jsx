...
const ENDPOINT = "INSTALACIONES_ELÉCTRICAS_BT/RBT0_Memoria_Técnica_De_Diseño/Bt040401InstalaciónEléctricaDeViviendaUnifamiliarConGradoDeElectrificaciónBásico/Bt040401"
const HOJAEXCEL = "excel/INSTALACIONES_ELÉCTRICAS_BT/RBT0_Memoria_Técnica_De_Diseño/Bt040401.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Bt040401`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Bt040401)
