...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind060anexoiiCálculoDelRendimientoEstacionalDeEquipos/Ind060anexoii"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind060anexoii.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind060anexoii`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind060anexoii)
