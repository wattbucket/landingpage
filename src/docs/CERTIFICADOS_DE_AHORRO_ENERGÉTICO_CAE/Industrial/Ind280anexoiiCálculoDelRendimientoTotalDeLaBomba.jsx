...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind280anexoiiCálculoDelRendimientoTotalDeLaBomba/Ind280anexoii"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind280anexoii.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind280anexoii`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind280anexoii)
