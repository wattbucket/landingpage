...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind230anexoiiInformeJustificativoDeLosEquiposQueCeden/Ind230anexoii"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind230anexoii.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind230anexoii`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind230anexoii)
