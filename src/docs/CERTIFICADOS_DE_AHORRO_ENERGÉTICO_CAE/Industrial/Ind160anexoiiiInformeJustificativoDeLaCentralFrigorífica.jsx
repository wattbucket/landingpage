...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind160anexoiiiInformeJustificativoDeLaCentralFrigorífica/Ind160anexoiii"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind160anexoiii.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind160anexoiii`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind160anexoiii)
