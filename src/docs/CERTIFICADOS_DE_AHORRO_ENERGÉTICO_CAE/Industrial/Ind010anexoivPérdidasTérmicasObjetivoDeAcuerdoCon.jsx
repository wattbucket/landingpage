...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind010anexoivPérdidasTérmicasObjetivoDeAcuerdoCon/Ind010anexoiv"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind010anexoiv.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind010anexoiv`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind010anexoiv)
