...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind150anexoiiiInformeJustificativoDeLaCentralFrigorífica/Ind150anexoiii"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind150anexoiii.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind150anexoiii`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind150anexoiii)
