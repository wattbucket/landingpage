...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind040anexoiiiDemandaAnualDeEnergíaParaAcs/Ind040anexoiii"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind040anexoiii.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind040anexoiii`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind040anexoiii)
