...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind260anexoiiDeclaraciónResponsablePorLaEmpresa/Ind260anexoii"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind260anexoii.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind260anexoii`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind260anexoii)
