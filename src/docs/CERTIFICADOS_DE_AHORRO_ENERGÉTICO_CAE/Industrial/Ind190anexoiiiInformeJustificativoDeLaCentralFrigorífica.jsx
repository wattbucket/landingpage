...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind190anexoiiiInformeJustificativoDeLaCentralFrigorífica/Ind190anexoiii"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind190anexoiii.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind190anexoiii`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind190anexoiii)
