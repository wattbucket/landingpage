...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind060anexoivFórmulasParaObtenerLosCoeficientesDe/Ind060anexoiv"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind060anexoiv.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind060anexoiv`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind060anexoiv)
