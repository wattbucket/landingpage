...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind010anexovPérdidasTérmicasParaEscenarioBaseDe/Ind010anexov"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind010anexov.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind010anexov`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind010anexov)
