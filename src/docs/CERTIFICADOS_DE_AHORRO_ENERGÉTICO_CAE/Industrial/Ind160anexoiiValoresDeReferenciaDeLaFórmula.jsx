...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind160anexoiiValoresDeReferenciaDeLaFórmula/Ind160anexoii"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Industrial/Ind160anexoii.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Ind160anexoii`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Ind160anexoii)
