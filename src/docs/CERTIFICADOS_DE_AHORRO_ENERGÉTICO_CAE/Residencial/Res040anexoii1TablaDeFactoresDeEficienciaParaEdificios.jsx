...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res040anexoii1TablaDeFactoresDeEficienciaParaEdificios/Res040anexoii1"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res040anexoii1.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Res040anexoii1`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Res040anexoii1)
