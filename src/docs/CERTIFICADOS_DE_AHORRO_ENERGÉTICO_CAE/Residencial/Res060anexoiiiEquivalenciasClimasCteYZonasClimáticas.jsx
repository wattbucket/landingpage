...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res060anexoiiiEquivalenciasClimasCteYZonasClimáticas/Res060anexoiii"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res060anexoiii.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Res060anexoiii`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Res060anexoiii)
