...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res060anexoviCondicionesConsideradasEnAcs/Res060anexovi"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res060anexovi.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Res060anexovi`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Res060anexovi)
