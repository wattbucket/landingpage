...
const ENDPOINT = "CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res092anexoiiiTablaDeCoeficientes1DeCoberturaPorBivalencia/Res092anexoiii"
const HOJAEXCEL = "excel/CERTIFICADOS_DE_AHORRO_ENERGÉTICO_CAE/Residencial/Res092anexoiii.xlsx"
    ...
    useEffect(() => {
        const loadDataFromSessionStorage = async () => {
            ...
            if (storedData) {
                ...
                console.log(`Res092anexoiii`)
                console.log(excelData)
                console.log('+++++==========================================================')
                if (excelData.Res092anexoiii)
